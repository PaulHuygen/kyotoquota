...
@d quota settings @{@%
max_quota_perc=m4_max_quota_perc
...
@d quota settings @{@%
minfreespace_perc=m4_minfreespace_perc
...
@d quota settings @{@%
reduction_perc=m4_reduction_perc
...
@d find username in line of password-file @{@%
@2=`echo @1 | gawk '{print $1}' FS=':'`
@| @}

@d find group-id in line of password-file @{@%
...
disk_capacity=`df m4_device 2>/dev/null | gawk 'NR==2 {print $2}'`
...
@d determine whether quota should be reduced or possibly expanded @{@%
change="No"
if
